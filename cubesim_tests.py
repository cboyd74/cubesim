...
class CubeSimTests():
	...
	def test_side_rotate_right(self):
		...
		side.values[0] = [5, 6, 7] 
		verify_side = [[1, 1, 5], [1, 1, 6], [1, 1, 7]] 	
		side.rotate_right()
		if (not self.compare_side(side.values, verify_side)):
			return False, "test_side_rotate_right() test 1: failed."

		verify_side = [[1, 1, 1], [1, 1, 1], [7, 6, 5]]
		side.rotate_right()
		if (not self.compare_side(side.values, verify_side)):
			return False, "test_side_rotate_right() test 2: failed."

		return True, "test_side_rotate_right: all tests passed."
	...
	def test_side_rotate_left(self):
		...
		return True, "test_side_rotate_left: all tests passed."
	...
	def test_front_move(self):
		...
		#all sides except back needed.
			
		return True, "test_front_move: all tests passed."

	def test_front_prime(self):
		print("")
		return True, "test_front_prime: all tests passed."

	def test_right_move(self):
		print("")
		return True, "test_right_move: all tests passed."

	def test_right_prime(self):
		print("")
		return True, "test_right_prime: all tests passed."
